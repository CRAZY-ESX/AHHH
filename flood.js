...
if (!reqmethod || !target || !time || !threads || !ratelimit || !proxyfile) {
    console.clear();
    console.error(`
    TORNADO v1.3 Method With RST STREAM (CVE-2023-44487) // Updated: 31.01.2024 // With love  for mesh botnet
    Developers to method: @vampirenetworks - recoding method // rapidreset - improved to settings // system ai logic
    How to use & example:
